...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2fe64bcb2f4908a9677e88d3a541eec9) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("alcotest", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("alcotest", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = None;
          synopsis = "A light and colored test framework";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "6D¡\159±9º¢\157Éâ\132e\031÷Æ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
